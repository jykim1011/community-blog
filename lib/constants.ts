...
export const siteConfigs: Record<string, { displayName: string; url: string; category: SiteCategory }> = {
  ...
  fmkorea: { displayName: '에펨코리아', url: 'https://www.fmkorea.com', category: 'community' },
  inven: { displayName: '인벤', url: 'https://www.inven.co.kr', category: 'game' },
  arca: { displayName: '아카라이브', url: 'https://arca.live', category: 'community' },
  ...
  humoruniv: { displayName: '웃긴대학', url: 'https://www.humoruniv.com', category: 'community' },
  ...
  damoang: { displayName: '다모앙', url: 'https://damoang.net', category: 'community' },
  orbi: { displayName: '오르비', url: 'https://orbi.kr', category: 'community' },
  ...
  dvdprime: { displayName: 'DVDPrime', url: 'https://dvdprime.com', category: 'movie' },
  dealbada: { displayName: '딜바다', url: 'http://www.dealbada.com', category: 'hotdeal' },
  coolenjoy: { displayName: '쿨엔조이', url: 'https://coolenjoy.net', category: 'community' },
};
