...
- ⏳ 8단계: Google Play 출시 (80% - 앱 생성, AAB 준비, 심사 대기)
- ⏳ 9단계: SEO 및 마케팅 (0%)
...
- **Play Store 출시 80% 완료** (앱 생성, AAB 빌드, 스크린샷, 등록 진행 중)
- **다음 단계: Play Console 앱 콘텐츠 설정 완료 → 개발자 승인 대기 → 심사 제출**
...
- [x] Android Studio에서 Release AAB 빌드 (AdMob 실제 ID 포함)
- [x] 스크린샷 3장 준비 (메인, 필터, 페이지네이션)
- [ ] Play Console 앱 콘텐츠 설정 (진행 중):
  - [ ] 개인정보처리방침 URL 입력
  - [ ] 앱 액세스 권한 설정
  - [ ] 광고 포함 선택
  - [ ] 콘텐츠 등급 설문 완료
